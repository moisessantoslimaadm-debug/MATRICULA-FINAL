...
import { MapPin, Star, Users, Search, Map as MapIcon, List, X, GraduationCap, Calendar, Hash, School as SchoolIcon, Layout, Filter, ArrowUpDown, ChevronDown, AlertTriangle, Accessibility } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-50 py-8 md:py-12 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Filters & Sorting */}
        <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-slate-200 mb-8 flex flex-col md:flex-row gap-4 items-center justify-between sticky top-20 z-30">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
            ...
            <div className="relative w-full sm:w-auto">
                ...
                <select
                    ...
                    className="w-full sm:w-48 pl-10 pr-8 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none bg-white text-sm text-slate-700 cursor-pointer appearance-none"
                >
              ...
              <div key={school.id} className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition duration-300 group flex flex-col h-full">
                ...
                <div className="p-5 flex-1 flex flex-col">
                  ...
                  <div className="pt-4 border-t border-slate-100 mt-auto">
                    <div className="flex items-center gap-2 text-slate-600 mb-3" title="Capacidade Total">
                      <Users className="h-4 w-4 text-slate-400" />
                      <span className="text-sm font-medium text-slate-700">{school.availableSlots > 0 ? `${school.availableSlots} Vagas Disponíveis` : 'Lotação não inf.'}</span>
                    </div>
                    ...
                    <div className="flex flex-col gap-2">
                        <button 
                            ...
                            className="w-full text-blue-600 text-sm font-bold hover:text-blue-800 transition-colors flex items-center justify-center gap-2 bg-blue-50 hover:bg-blue-100 px-3 py-2 rounded-lg"
                        >
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <button 
                                onClick={() => alert(`Agendamento de visita para ${school.name} em breve.`)}
                                className="flex items-center justify-center gap-1.5 px-2 py-2 rounded-lg text-xs font-semibold text-slate-600 bg-slate-100 hover:bg-slate-200 transition border border-slate-200"
                            >
                                <Calendar className="h-3 w-3" />
                                Agendar Visita
                            </button>
                            <button 
                                onClick={() => alert(`Denúncia para ${school.name} registrada anonimamente.`)}
                                className="flex items-center justify-center gap-1.5 px-2 py-2 rounded-lg text-xs font-semibold text-red-600 bg-red-50 hover:bg-red-100 transition border border-red-100"
                            >
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="flex items-center gap-3 text-xs text-slate-500 mt-0.5">
                                                            ...
                                                            {student.specialNeeds && (
                                                                <span className="flex items-center gap-1 text-purple-700 bg-purple-50 px-1.5 py-0.5 rounded border border-purple-100 font-bold" title="Aluno com Necessidades Educacionais Especiais (AEE)">
